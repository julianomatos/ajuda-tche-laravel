    ...
    <header>
        <nav class="navbar navbar-expand-md fixed-top">
            <div class="container-fluid menu">
                <img src="{{ asset('imagens/ajudatche-logo.svg') }}" alt="Descrição da imagem">
...
{{--                                <li><a class="dropdown-item" href="/cadastro">Cadastre-se ajudatchê</a></li>--}}
    ...
    <main>
        ...
        <div class="destaque-container">
            ...
            <div class="destaque-imagem">
                ...
                <img src="{{ asset('imagens/destaque.jpg') }}" alt="Descrição da imagem">
            </div>
        </div>
    ...
    <footer class="footer row">
        ...
        <div class="footer-column col-12 col-md-12 col-lg-4">
            ...
            <img src="{{ asset('imagens/ajudatche-logo-branco.svg')}}" alt="">
        </div>
    </footer>

    <div class="logo row -p5">
        <div class="col-6">
    ...
    <script src="{{ asset('js/scriptCard.js') }}" defer></script>
    </body>
</html>
